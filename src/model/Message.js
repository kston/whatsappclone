...
export class Message extends Model {
  ...
  getViewElement(me = true) {
    ...
    switch (this.type) {
      case 'contact':
        ...
        break;
      case 'image':
        element.innerHTML = ` <div class="_3_7SH _3qMSo ">
    <div class="KYpDv">
        <div>
    ...
    <div class="_3S8Q-" role="button">
        ...
        break;
      case 'document':
        element.innerHTML = ` <div class="_3_7SH _1ZPgd ">
    <div class="_1fnMt _2CORf">
        ...
        break;
      case 'audio':
        element.innerHTML = `<div class="_3_7SH _17oKL ">
    ...
    <div class="_3S8Q-" role="button">
        ...
        let load = element.querySelector('.audio-load');
        ...
        element.querySelector('.message-audio-duration').innerHTML = Format.toTime(
          this.duration * 1000
        );
        ...
        break;
      default:
        element.innerHTML = ` <div class="font-style _3DFk6 tail >
        <span class="tail-container"></span>
        <span class="tail-container highlight"></span>
        <div class="Tkt2p">
  ...
  static sendImage(chatId, from, file) {
    return new Promise((resolve, reject) => {
      Message.upload(file, from).then((downloadURL) => {
        Message.send(chatId, from, 'image', downloadURL).then((msgRef) => {
          msgRef.set(
            {
              content: downloadURL,
              status: 'sent',
